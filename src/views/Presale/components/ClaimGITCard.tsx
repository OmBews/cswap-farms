           ...
           <FCard>
                ...
                <Image src="/images/egg/2.png" width={50} height={50} />
                    <Flex flexDirection="column" alignItems="flex-end">
                        <Heading mb="4px">Claim Your CSWAP</Heading>
                    </Flex>
                </Wrapper>
                ...
                <Flex justifyContent='space-between' mb="10px">
                    <Text>Your unclaimed CSWAP:</Text>
                    <Text bold>{unclaimed.toLocaleString(undefined, { maximumFractionDigits: 2 })} CSWAP</Text>
                </Flex>
                <Flex justifyContent='space-between' mb="10px">
                    <Text>CSWAP in your wallet</Text>
                    <Text bold>{GITBalance.toLocaleString(undefined, { maximumFractionDigits: 2 })} CSWAP</Text>
                </Flex>
                <Action>
                    {account ?
                        <>
